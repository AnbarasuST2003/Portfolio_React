			...
			<div className="contact__containe grid">
				<div className="contact__data">
					...
					<p className="contact__description-2">
						If you would like to share your <b>Name</b> and <b>Email Address</b>, please know that you will only receive a response from me —no additional communications will be sent.
					</p>
				</div>
				...
				<div className="contact__social">
					...
					<div className="contact__social-data">
						...
						<div className="contact__social-links">
							...
							<a
								href="mailto:anbarasuthangaraj9@gmail.com"
								target="_blank"
								className="contact__social-link"
							>
